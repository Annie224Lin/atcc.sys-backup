...
remove_files(){
        ...
        [ -f ${ABS_EXT4_OUT_DIR}/etc/ssh/ssh_host_ed25519_key ] && rm ${ABS_EXT4_OUT_DIR}/etc/ssh/ssh_host_ed25519_key
        [ -f ${ABS_EXT4_OUT_DIR}/etc/ssh/ssh_host_dsa_key ] && rm ${ABS_EXT4_OUT_DIR}/etc/ssh/ssh_host_dsa_key
        [ -f ${ABS_EXT4_OUT_DIR}/etc/ssh/ssh_host_ecdsa_key ] && rm ${ABS_EXT4_OUT_DIR}/etc/ssh/ssh_host_ecdsa_key
        [ -f ${ABS_EXT4_OUT_DIR}/etc/ssh/ssh_host_rsa_key ] && rm ${ABS_EXT4_OUT_DIR}/etc/ssh/ssh_host_rsa_key
